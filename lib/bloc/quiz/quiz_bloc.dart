import 'package:quiz_bloc/bloc/quiz/quiz_event.dart';
...
class QuizBloc extends Bloc<QuizEvent, QuizState> {
  ...
  QuizBloc(this.prepareQuizHelper)
      : super(QuizOnGoingState(0, 0, 0, 0, 0, prepareQuizHelper.getQuestion(0),
    ...
    on<QuizFinished>((event, emit) async {
      if (event.selectedIndex != -1 &&
          prepareQuizHelper.isCorrect(currentIndex, event.selectedIndex)) {
      ...
      ++currentIndex;
      QuizState finishedState = QuizFinishedState(formulaScore, currentIndex,
          currentAttempts, currentWrongAttempts, currentCorrectAttempts);
      emit(finishedState);
    });
